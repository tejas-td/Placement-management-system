        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="https://www.bit-bangalore.edu.in/">Bangalore Institute of Technology</a>
                </div>
        ...
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					...
					<p>phno: 080-26615865</p>
					<a href="mailto:BIT@gmail.com">BIT@gmail.com</a>
				</div>
				<div class="col-md-3 ftr-logo">
					<p>Copyright &copy; BIT-2020
				</div>
